<template>
  <div class="control-pattern-lines relative rounded-xl bg-white p-4 shadow ring-1 ring-slate-200">
    ...
    <div class="flex flex-wrap justify-center gap-4">
      <div v-for="(img, index) in images" :key="index" class="relative">
        ...
        <button
          type="button"
          class="absolute right-2 top-2 grid size-6 rounded-full bg-red-500 text-white"
