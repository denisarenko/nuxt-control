<template>
  <div v-if="editor.isActive('youtube') || youtubeLink" class="flex gap-1.5 p-1.5" :class="classColor">
    ...
    <button v-if="linkHref" type="button" :class="classButton" @click="linkHref = ''">
