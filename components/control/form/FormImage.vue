<template>
  <div
    class="bg-white ring-1 ring-slate-200 shadow relative bg-dot rounded-lg p-5"
  >
    <input
      type="file"
    ...
    <img
      ...
      :src="image || preview"
      alt="Image"
      class="mx-auto max-w-sm rounded-2xl shadow"
    />
    ...
    <div v-else class="py-2 text-center">
      <svg
        ...
        viewBox="0 0 512 512"
        class="mx-auto size-10 mb-4 text-slate-400"
      >
        <path
          fill="currentColor"
