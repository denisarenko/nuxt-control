<template>
  ...
  >
    ...
    <div class="p-3 flex-1 font-medium truncate" :title>
      {{ title }}
    </div>
    ...
    >
      <slot name="actions">
        <NuxtLink :to="actionEdit" class="hover:bg-slate-50 duration-200"> Edit </NuxtLink>

        <button type="button" @click="actionDelete" class="hover:bg-slate-50 hover:text-red-500 duration-200">
          Delete
        </button>
      </slot>
    </div>
