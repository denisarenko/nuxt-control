  ...
  >
    <div class="rounded-[11px] flex flex-col h-full">
      ...
      <div
        ...
        class="mt-px flex *:flex-1 *:p-2 *:duration-200 text-center text-sm gap-px rounded-b-[11px] overflow-hidden"
      >
        <slot name="actions">
          <NuxtLink :to="actionEdit" class="flex gap-3 items-center justify-center bg-white/95">
          ...
          <button
            type="button"
            @click="actionDelete"
            class="bg-white/95 hover:bg-red-50/95 hover:text-red-500 flex gap-3 items-center justify-center"
          >
