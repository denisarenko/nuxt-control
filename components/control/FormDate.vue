  ...
  <div class="relative z-10">
    ...
    >
      <div
        ...
        class="absolute z-[1] mt-2 rounded-xl bg-white shadow-lg duration-200"
        ...
        <div class="p-2">
          <div v-for="week in calendar" :key="week" class="grid grid-cols-7 gap-1 py-1 text-center">
            <button
              ...
              :key="date.id"
              type="button"
              class="size-8 rounded-md hover:bg-black/10"
              :class="{ 'bg-green-500 text-white': isDateSelected(date), 'pointer-events-none': !date.date }"
...
const initDatepicker = () => {
  ...
  currentMonth.value = now.toLocaleString('default', { month: 'long', year: 'numeric' });
...
const toggleMonth = (direction) => {
  ...
  currentMonth.value = currentDate.toLocaleString('default', { month: 'long', year: 'numeric' });
